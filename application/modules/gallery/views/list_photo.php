<?php $this->load->view('album/form_photo'); ?>
    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title"><?php echo $this->lang->line('page_photo_list_header'); ?></h3>
            ...
            <div class="box-body table-responsive">
                <?php echo form_open(site_url('photo/view'), array('id' => 'form-album-view')); ?>
                    <input type="hidden" name="itemId" value="">
                <?php echo form_close(); ?>
                <?php echo form_open(site_url('photo/edit'), array('id' => 'form-album-edit')); ?>
                    <input type="hidden" name="itemId" value="">
                <?php echo form_close(); ?>
                <?php echo form_open(site_url('photo/delete'), array('id' => 'form-album-delete')); ?>
                    <input type="hidden" name="itemId" value="">
                <?php echo form_close(); ?>
                <table id="photo-list" data-responsive="responsive" class="table table-condensed table-responsive table-bordered table-striped display">
                    <thead>
                        <tr>
